# ORCID Trademark Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner-verified_1200x1200.svg)](#)
[![logo](/Pictures/banner-unverified_1200x1200.svg)](#)

The ORCID Trademarks Logo. They publishes detailed trademark guidelines and even
supply the desired `svg` format which has has non-destructive scale up & down
properties and can be converted into any rasterized images (e.g. `jpeg`, `webp`,
`avif`, etc).

Hence, the re-draw is mainly to keep a compatible copy with us.

This project re-draws ORCID Trademarks Logo specifically for 1200x1200 size.
...
Please read through ORCID's Trademark Engineering Specification
(https://info.orcid.org/documentation/integration-guide/orcid-id-display-guidelines/)
before editing to avoid any unwanted legal implications.

While not specified by ORCID, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: ORCID Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-orcid-1200x1200
UUID: 59FBAD2E-6C73-4692-BB1A-45C01D046FEB
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-02
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-orcid-1200x1200
--------------------------------------------------------------------------------
```
...
> **YOU ARE STILL OBLIGATED TO COMPLY WITH ORCID TRADEMARK REQUIREMENTS
> (Read: https://info.orcid.org/documentation/integration-guide/orcid-id-display-guidelines/)**.
>
